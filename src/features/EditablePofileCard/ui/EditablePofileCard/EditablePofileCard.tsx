...
import { ValidateProfileError } from '../../model/types/EditablePofileCardSchema'
import cls from './EditablePofileCard.module.scss'
...
export const EditablePofileCard = memo((props: EditablePofileCardProps) => {
  const {
    className,
    id,
  } = props
